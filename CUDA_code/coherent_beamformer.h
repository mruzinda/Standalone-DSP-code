...
#define N_POL 1 //2    // Number of polarizations
#define N_TIME 1 // 8   // Number of time samples
#define N_BIN 10 //100  // Number of frequency bins after second FFT.  Should actually be 2^14, but due to limited memory on my laptop, arbitrarily 100
#define N_ANT 8 // 64   // Number of antennas
#define N_BEAM 5 // 64  // Number of beams
